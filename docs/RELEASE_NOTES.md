...
- `src-tauri/target/release/bundle/msi/Lattice_2.1.0_x64_en-US.msi`
- `src-tauri/target/release/bundle/nsis/Lattice_2.1.0_x64-setup.exe`
...
- 若你通过 GitHub Releases 分发桌面版，请上传 `releases/v2.1.0/` 中的最新产物
