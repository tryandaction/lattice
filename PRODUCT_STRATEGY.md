...
- Windows 桌面端唯一标题栏 + `Command Bar` 工作台
- 按工作区恢复 `pane / split / tab / active pane / active tab`
- PDF 条目工作区 v2
...
- 本轮已经把 PDF 左栏收成“可折叠条目区 + 紧凑批注侧栏”
- 下一阶段不再做“继续加顶部工具条”，而是优先做批注结构化整理、批量归档和条目级元数据
...
当前这轮收敛后，最适合进入的新阶段不是再做零散体验 patch，而是选一条完整产品线向前推进：

1. `PDF 条目元数据面板`
2. `批注整理 / 学习卡片 / 文献摘要`
3. `跨 PDF 证据比较与 AI 研究综述`
4. `工作区级 session / layout 可视化管理`

建议下一窗口优先做第 1 或第 2 项，因为这两项最直接强化 Lattice 相对 Zotero / Obsidian 的差异化。
